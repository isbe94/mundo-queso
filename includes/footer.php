            ...
            <div class="col-12 col-md-6 col-lg-4 mb-4">
                ...
                <div class="contact-info">
                    <div class="contact-item mb-2">
                        <span> <i class="fas fa-map-marker-alt me-2"></i>Calle del Queso 123, Madrid, España</span>
                    </div>
                    <div class="contact-item mb-2">
                        <span><i class="fas fa-phone me-2"></i>+34 98 123 45 67</span>
                    </div>
                    <div class="contact-item mb-3">
                        <span><i class="fas fa-envelope me-2"></i>info@mundoqueso.es</span>
                    </div>
                </div>
                ...
                <div class="newsletter-signup">
                    ...
                    <form class="d-flex gap-2 flex-wrap flex-sm-nowrap align-items-center">
                        <input type="email" class="form-control form-control-sm" placeholder="Tu email" required>
